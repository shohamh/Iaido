...
class SettingsActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent { NinjaKeysTheme { SettingsScreen() } }
    }
    ...
    private fun SettingsScreen() {
        ...
        Column(
            ...
            Text("NinjaKeys Settings", style = androidx.compose.material3.MaterialTheme.typography.headlineSmall)
            ...
            Text("Enable NinjaKeys in Android system settings, then choose it from the keyboard picker.")
