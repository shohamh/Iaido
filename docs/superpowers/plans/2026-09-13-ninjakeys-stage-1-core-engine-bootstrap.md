# NinjaKeys Stage 1: Core-Engine Bootstrap Implementation Plan
...
- Base package: `com.ninjakeys`; `core-engine` code lives under `com.ninjakeys.core`.
...
- Create: `core-engine/src/main/kotlin/com/ninjakeys/core/.gitkeep`
- Create: `core-engine/src/test/kotlin/com/ninjakeys/core/.gitkeep`
- Create: `app/build.gradle.kts`
- Create: `app/src/main/AndroidManifest.xml`
- Create: `app/src/main/kotlin/com/ninjakeys/app/.gitkeep`

**Interfaces:**
- Produces: a Gradle project with two modules, `:core-engine` (Kotlin/JVM library) and `:app` (empty Android application, applicationId `com.ninjakeys.app`), both building successfully.
...
`core-engine/src/main/kotlin/com/ninjakeys/core/.gitkeep` — empty file.
`core-engine/src/test/kotlin/com/ninjakeys/core/.gitkeep` — empty file.
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android">
    <application
        android:label="NinjaKeys"
        android:allowBackup="true">
    </application>
</manifest>
```

`app/src/main/kotlin/com/ninjakeys/app/.gitkeep` — empty file.
...
**Files:**
- Create: `core-engine/src/main/kotlin/com/ninjakeys/core/gesture/GesturePoint.kt`
- Create: `core-engine/src/main/kotlin/com/ninjakeys/core/gesture/GesturePath.kt`
- Test: `core-engine/src/test/kotlin/com/ninjakeys/core/gesture/GesturePathTest.kt`
...
Run: `./gradlew :core-engine:test --tests "com.ninjakeys.core.gesture.GesturePathTest"`
...
```bash
git add core-engine/src/main/kotlin/com/ninjakeys/core/gesture/ core-engine/src/test/kotlin/com/ninjakeys/core/gesture/GesturePathTest.kt
...
**Files:**
- Create: `core-engine/src/main/kotlin/com/ninjakeys/core/layout/KeyPosition.kt`
- Create: `core-engine/src/main/kotlin/com/ninjakeys/core/layout/KeyboardLayout.kt`
- Test: `core-engine/src/test/kotlin/com/ninjakeys/core/layout/KeyboardLayoutTest.kt`
...
Run: `./gradlew :core-engine:test --tests "com.ninjakeys.core.layout.KeyboardLayoutTest"`
...
```bash
git add core-engine/src/main/kotlin/com/ninjakeys/core/layout/ core-engine/src/test/kotlin/com/ninjakeys/core/layout/KeyboardLayoutTest.kt
...
**Files:**
- Create: `core-engine/src/main/kotlin/com/ninjakeys/core/dictionary/WordEntry.kt`
- Create: `core-engine/src/main/kotlin/com/ninjakeys/core/recognition/CandidateGenerator.kt`
- Create: `core-engine/src/main/kotlin/com/ninjakeys/core/recognition/TrieCandidateGenerator.kt`
- Test: `core-engine/src/test/kotlin/com/ninjakeys/core/recognition/TrieCandidateGeneratorTest.kt`
...
Run: `./gradlew :core-engine:test --tests "com.ninjakeys.core.recognition.TrieCandidateGeneratorTest"`
Expected: FAIL (compile error — types don't exist yet).
...
```bash
git add core-engine/src/main/kotlin/com/ninjakeys/core/dictionary/ core-engine/src/main/kotlin/com/ninjakeys/core/recognition/CandidateGenerator.kt core-engine/src/main/kotlin/com/ninjakeys/core/recognition/TrieCandidateGenerator.kt core-engine/src/test/kotlin/com/ninjakeys/core/recognition/TrieCandidateGeneratorTest.kt
...
**Files:**
- Create: `core-engine/src/main/kotlin/com/ninjakeys/core/recognition/ScoredCandidate.kt`
- Create: `core-engine/src/main/kotlin/com/ninjakeys/core/recognition/PathScorer.kt`
- Create: `core-engine/src/main/kotlin/com/ninjakeys/core/recognition/ShapePathScorer.kt`
- Create: `core-engine/src/main/kotlin/com/ninjakeys/core/recognition/ScoringConstants.kt`
- Test: `core-engine/src/test/kotlin/com/ninjakeys/core/recognition/ShapePathScorerTest.kt`
...
Run: `./gradlew :core-engine:test --tests "com.ninjakeys.core.recognition.ShapePathScorerTest"`
Expected: FAIL (compile error — types don't exist yet).
...
```bash
git add core-engine/src/main/kotlin/com/ninjakeys/core/recognition/ScoredCandidate.kt core-engine/src/main/kotlin/com/ninjakeys/core/recognition/PathScorer.kt core-engine/src/main/kotlin/com/ninjakeys/core/recognition/ShapePathScorer.kt core-engine/src/main/kotlin/com/ninjakeys/core/recognition/ScoringConstants.kt core-engine/src/test/kotlin/com/ninjakeys/core/recognition/ShapePathScorerTest.kt
...
**Files:**
- Create: `core-engine/src/main/kotlin/com/ninjakeys/core/recognition/GestureRecognizer.kt`
- Test: `core-engine/src/test/kotlin/com/ninjakeys/core/recognition/GestureRecognizerTest.kt`
...
Run: `./gradlew :core-engine:test --tests "com.ninjakeys.core.recognition.GestureRecognizerTest"`
...
```bash
git add core-engine/src/main/kotlin/com/ninjakeys/core/recognition/GestureRecognizer.kt core-engine/src/test/kotlin/com/ninjakeys/core/recognition/GestureRecognizerTest.kt
...
Plan complete and saved to `docs/superpowers/plans/2026-09-13-ninjakeys-stage-1-core-engine-bootstrap.md`. Two execution options:
