# Iaido Stage 3: Real English Dictionary Implementation Plan
...
**Spec:** `wayfinder/tickets/002-dictionary-research.md` and Stage 3 in `docs/superpowers/plans/2026-09-13-iaido-roadmap.md`.
