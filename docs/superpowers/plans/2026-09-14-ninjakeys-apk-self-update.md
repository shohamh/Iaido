# NinjaKeys APK self-update Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:executing-plans (recommended) to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Add a Settings update action that downloads the newest signed NinjaKeys APK from GitHub Releases and hands it to Android's package installer.
...
**Spec:** `docs/superpowers/specs/2026-09-14-ninjakeys-apk-self-update-design.md`
...
**Files:**
- Create: `app/src/main/kotlin/com/ninjakeys/app/AppUpdateRelease.kt`
- Test: `app/src/test/kotlin/com/ninjakeys/app/AppUpdateReleaseTest.kt`
...
- [x] **Step 2: Run `:app:testDebugUnitTest --tests com.ninjakeys.app.AppUpdateReleaseTest` and confirm failure.**
...
**Files:**
- Create: `app/src/main/kotlin/com/ninjakeys/app/AppUpdateClient.kt`
- Create: `app/src/main/res/xml/app_update_paths.xml`
- Modify: `app/src/main/AndroidManifest.xml`
- Test: `app/src/test/kotlin/com/ninjakeys/app/AppUpdateClientTest.kt`
...
**Files:**
- Modify: `app/src/main/kotlin/com/ninjakeys/app/SettingsActivity.kt`
- Create: `app/src/test/kotlin/com/ninjakeys/app/AppUpdateUiStateTest.kt`
