# NinjaKeys Stage 2: Minimal IME Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax.

**Goal:** Install NinjaKeys as a minimal Android IME that renders a hardcoded QWERTY keyboard, recognizes one-finger swipes with Stage 1, and commits the winning word.

**Architecture:** The Android app owns `NinjaKeysInputMethodService` and a Compose input view. A pure Kotlin `SwipeCommitController` bridges the view's completed `GesturePath` to the existing `GestureRecognizer`, keeping commit behavior JVM-testable and leaving Android types at the app boundary.
...
**Spec:** `docs/superpowers/specs/2026-09-13-ninjakeys-stage-2-minimal-ime-design.md`
...
Declare `android.permission.BIND_INPUT_METHOD`, register `NinjaKeysInputMethodService` as exported with the bind permission, and point service metadata at `@xml/method`.
...
**Files:**
- Create: `app/src/main/kotlin/com/ninjakeys/app/SwipeCommitController.kt`
- Create: `app/src/test/kotlin/com/ninjakeys/app/SwipeCommitControllerTest.kt`
...
Run `./gradlew :app:testDebugUnitTest --tests "com.ninjakeys.app.SwipeCommitControllerTest" --no-daemon`; expect compilation failure because the controller does not exist.
...
```text
git add app/src/main/kotlin/com/ninjakeys/app/SwipeCommitController.kt app/src/test/kotlin/com/ninjakeys/app/SwipeCommitControllerTest.kt
...
**Files:**
- Create: `app/src/main/kotlin/com/ninjakeys/app/KeyboardInputView.kt`
- Create: `app/src/main/kotlin/com/ninjakeys/app/StageOneDictionary.kt`
...
```text
git add app/src/main/kotlin/com/ninjakeys/app/KeyboardInputView.kt app/src/main/kotlin/com/ninjakeys/app/StageOneDictionary.kt
...
**Files:**
- Create: `app/src/main/kotlin/com/ninjakeys/app/NinjaKeysInputMethodService.kt`
...
git add app/src/main/kotlin/com/ninjakeys/app/NinjaKeysInputMethodService.kt
