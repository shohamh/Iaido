# Iaido Stage 4: Flick Punctuation and IME Conveniences Implementation Plan
...
**Files:** Create `app/src/main/kotlin/com/iaido/app/TypingController.kt` and its JVM tests.
...
**Files:** Modify `KeyboardInputView.kt` and `IaidoInputMethodService.kt`.
